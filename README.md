...
| --- | --- | --- | --- | --- |
| ![Lingo](./img/mascot.svg) | [**Duolingo Clone Repo**](https://github.com/jeancdevx/duolingo-clone) | A clone of the Duolingo app | `NextJS` `Tailwind` `Typescript` `Neon Database` | [**Duolingo Clone**](https://duolingo-clone.vercel.app) |
